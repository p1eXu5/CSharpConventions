...
| Constants name            | ALL_CAPS   |     50 | No     | No     | No     | No           | [A-z][0-9]         | Yes         |
...
## Class components order
### Modifiers order
1) <code>public</code>
2) <code>internal</code>
3) <code>protected</code>
4) <code>protected internal</code>
5) <code>private protected</code>
6) <code>private</code>
...
2) <code>fields</code>
3) <code>ctor</code>
4) <code>finalizers (destructors)</code>
5) <code>delegates</code>
6) <code>events</code>
7) <code>enums</code>
8) <code>interface implementations</code>
9) <code>properties</code>
10) <code>indexers</code>
11) <code>methods</code>
12) <code>structs</code>
13) <code>classes</code>
...
### 10. Do use implicit type var for local variable declarations, when the type is evident. Exception: primitive types (int, string, double, etc) use predefined names. 
...
### 15. Do vertically align curly brackets in namespaces, classes and methods: 
...
### 22. Do use two parameters named sender and e in event handlers. The sender parameter represents the object that raised the event. The sender parameter is typically of type object, even if it is possible to employ a more specific type.
...
### 23. Do use suffix Exception at creation of the new classes comprising the information on exception:
...
### 24. Do use suffix Any, Is, Have or similar keywords for boolean identifier :
...
##### <div style="text-align: right;"><i>Edited by Vladimir Likhatskiy, 2020.</i></div>
...
5. [Reference - ktaranov / naming-convention](https://github.com/ktaranov/naming-convention/blob/master/C%23%20Coding%20Standards%20and%20Naming%20Conventions.md)
